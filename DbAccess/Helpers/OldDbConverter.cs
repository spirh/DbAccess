...
/// OldDbConverter
/// </summary>
public sealed class OldDbConverter : IDbConverter
{
    private static readonly Lazy<OldDbConverter> _instance = new(() => new OldDbConverter());

    /// <summary>
    /// Instance
    /// </summary>
    public static OldDbConverter Instance => _instance.Value;
